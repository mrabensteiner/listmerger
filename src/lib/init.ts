...
export function init(id: string, id_undo: string, id_redo: string, callback: g.DynamicFunction, items: Object, item_template: string, dialog_template: string, merge_template: string) {
  g.setItems(items); 
